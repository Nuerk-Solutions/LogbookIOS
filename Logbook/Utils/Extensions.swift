...
extension Color {
    static let circleTrackStart: Color = Color(r: 237, g: 242, b: 150)
    static let circleTrackEnd: Color = Color(r: 235, g: 248, b: 100)
    
    static let circleRoundStart: Color = Color(r: 71, g: 198, b: 0)
    static let circleRoundEnd: Color = Color(r: 90, g: 131, b: 0)
