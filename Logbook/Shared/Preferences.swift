...
final class Preferences {
    ...
    @UserDefault("allowLocationTracking")
    var allowLocationTracking: Bool = true
    
    @UserDefault("notifications")
    var notifications: Bool = true
    
    @UserDefault("notificationsIconBadge")
    var notificationsIconBadge: Bool = true
    
    @UserDefault("openAddViewOnStart")
    var openAddViewOnStart: Bool = false
    
    @UserDefault("openActivityViewAfterExport")
    var openActivityViewAfterExport: Bool = false
